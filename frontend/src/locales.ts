...
const en: Dict = {
  ...
  "tour.compare.body":
    "Rank every pool and asset by leveraged net APY, with live DEX Rates and history charts. No wallet needed.",
  // status page
...
const es: Dict = {
  ...
  "compare.foot":
    "El APY neto y el apal. máx usan el mismo factor de salud mínimo que el formulario de trading, así que coinciden con la posición que realmente puedes abrir; los resultados reales dependen de la variación de tasas y el gas. Las filas cuyo factor de colateral no alcanza el nivel seleccionado se ordenan según el apalancamiento que sí alcanzan. La tasa DEX es una cotización indicativa de 1 unidad → USDC vía el router del AMM. Los gráficos y las flechas de tendencia muestran el historial de APY de suministro neto del servicio de snapshots de Turbolong.",
  "tour.skip": "Omitir",
  "tour.next": "Siguiente",
  "tour.back": "Atrás",
  "tour.done": "Entendido",
...
const pt: Dict = {
  ...
  "compare.foot":
    "Alav. máx e APY alavancado usam o mesmo fator de saúde mínimo do formulário de trading, então correspondem à posição que você realmente pode abrir; os resultados reais dependem da variação das taxas e do gas. A taxa DEX é uma cotação indicativa de 1 unidade → USDC via roteador do AMM. A tendência mostra o histórico de APY de fornecimento líquido do serviço de snapshots da Turbolong.",
  "tour.skip": "Pular",
  "tour.next": "Próximo",
  "tour.back": "Voltar",
  "tour.done": "Entendi",
