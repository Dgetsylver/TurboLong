...
const en: Dict = {
  ...
  "compare.subtitle":
    "Live net APY across every Blend pool & asset, ranked at the leverage bracket you pick. Best swap rate sourced from Aquarius. No wallet needed.",
  "compare.col.rank": "#",
  "compare.col.poolAsset": "Pool / Asset",
  "compare.col.baseApy": "Base APY",
  "compare.col.levApy": "Leveraged APY",
  "compare.col.netApy": "Net APY",
  "compare.col.at": "At Lev",
  "compare.col.maxLev": "Max Lev",
  "compare.col.aquaRate": "Aqua Rate",
  "compare.col.trend": "Trend",
  "compare.leverage": "Leverage",
  "compare.history": "History",
  "compare.chart.label": "net supply APY",
  "compare.chart.empty": "Not enough history yet for this window.",
  "compare.scrollHint": "Scroll →",
  "compare.loading": "Loading pools…",
  "compare.empty": "No pools available.",
  "compare.bestRate": "Best Rate",
  "compare.foot":
    "Net APY and Max Lev use the same minimum health factor as the trade form, so they match the position you can actually open; actual results depend on rate drift and gas. Rows whose collateral factor can't reach the selected bracket are ranked at the leverage they do reach. Aquarius rate is an indicative quote for 1 unit → USDC via the AMM router. Charts and trend arrows show net supply APY history from the Turbolong snapshot service.",
  // onboarding tour
  "tour.skip": "Skip",
  "tour.next": "Next",
  "tour.back": "Back",
  ...
  "pos.effLeverage": "Effective leverage",
  "dashboard.liqRunway": "~{n} days to liquidation",
  "pool.whatsInside": "What's in this pool",
  "pool.colAsset": "Asset",
  "pool.colSupplied": "Supplied",
  "pool.colBorrowed": "Borrowed",
  "pool.colRole": "Role",
  "pool.role.loop": "Loop",
  ...
  "toast.alertsUnavailable": "Alerts service is unavailable right now — please try again later.",
...
const es: Dict = {
  ...
  "compare.subtitle":
    "APY neto en vivo de cada pool y activo de Blend, ordenados según el nivel de apalancamiento que elijas. Mejor tasa de intercambio vía Aquarius. Sin billetera.",
  "compare.col.rank": "#",
  "compare.col.poolAsset": "Pool / Activo",
  "compare.col.baseApy": "APY base",
  "compare.col.levApy": "APY apalancado",
  "compare.col.netApy": "APY neto",
  "compare.col.at": "Apal. usado",
  "compare.col.maxLev": "Apal. máx",
  "compare.col.aquaRate": "Tasa Aqua",
  "compare.col.trend": "Tendencia",
  "compare.leverage": "Apalancamiento",
  "compare.history": "Historial",
  "compare.chart.label": "APY de suministro neto",
  "compare.chart.empty": "Aún no hay suficiente historial para esta ventana.",
  ...
  "compare.foot":
    "El APY neto y el apal. máx usan el mismo factor de salud mínimo que el formulario de trading, así que coinciden con la posición que realmente puedes abrir; los resultados reales dependen de la variación de tasas y el gas. Las filas cuyo factor de colateral no alcanza el nivel seleccionado se ordenan según el apalancamiento que sí alcanzan. La tasa de Aquarius es una cotización indicativa de 1 unidad → USDC vía el router del AMM. Los gráficos y las flechas de tendencia muestran el historial de APY de suministro neto del servicio de snapshots de Turbolong.",
  "tour.skip": "Omitir",
  "tour.next": "Siguiente",
  "tour.back": "Atrás",
  "tour.done": "Entendido",
  ...
  "pos.effLeverage": "Apalancamiento efectivo",
  "dashboard.liqRunway": "~{n} días para la liquidación",
  "pool.whatsInside": "Qué hay en este pool",
  "pool.colAsset": "Activo",
  "pool.colSupplied": "Suministrado",
  "pool.colBorrowed": "Prestado",
  "pool.colRole": "Función",
  ...
  "toast.alertsUnavailable": "El servicio de alertas no está disponible ahora mismo — inténtalo de nuevo más tarde.",
...
const pt: Dict = {
  ...
  "pos.effLeverage": "Alavancagem efetiva",
  "dashboard.liqRunway": "~{n} dias até a liquidação",
  "pool.whatsInside": "O que há neste pool",
  "pool.colAsset": "Ativo",
  "pool.colSupplied": "Fornecido",
  "pool.colBorrowed": "Emprestado",
  "pool.colRole": "Função",
  "pool.role.loop": "Loop",
  ...
  "toast.alertsUnavailable": "O serviço de alertas está indisponível no momento — tente novamente mais tarde.",
