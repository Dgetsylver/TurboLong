...
const en: Dict = {
  ...
  "compare.foot": "Max Lev and Leveraged APY use the same minimum health factor as the trade form, so they match the position you can actually open; actual results depend on rate drift and gas. DEX rate is an indicative quote for 1 unit → USDC via the AMM router. Trend shows net supply APY history from the Turbolong snapshot service.",
  // onboarding tour
  "tour.skip": "Skip",
  "tour.next": "Next",
  "tour.back": "Back",
  ...
  "tour.compare.body": "Rank every pool and asset by leveraged net APY, with live DEX rates and history charts. No wallet needed.",
  // status page
...
const es: Dict = {
  ...
  "compare.foot": "Apal. máx y APY apalancado usan el mismo factor de salud mínimo que el formulario de trading, así que coinciden con la posición que realmente puedes abrir; los resultados reales dependen de la variación de tasas y el gas. La tasa DEX es una cotización indicativa de 1 unidad → USDC vía el router del AMM. La tendencia muestra el historial de APY de suministro neto del servicio de snapshots de Turbolong.",
  "tour.skip": "Omitir",
  "tour.next": "Siguiente",
  "tour.back": "Atrás",
  "tour.done": "Entendido",
  ...
  "tour.compare.body": "Ordena cada pool y activo por APY neto apalancado, con tasas DEX en vivo y gráficos históricos. Sin billetera.",
...
const pt: Dict = {
  ...
  "tour.compare.body": "Ordene cada pool e ativo por APY líquido alavancado, com taxas DEX ao vivo e gráficos históricos. Sem carteira.",
